package org.edgar.neo.framework.v2.servlet;

import org.edgar.neo.framework.annotation.*;
...
public class NeoDispatcherServlet extends HttpServlet {
            ...
            if(paramterType == HttpServletRequest.class){
                ...
                for (int j = 0; j < pa.length ; j ++) {
                    for(Annotation a : pa[i]){
                        if(a instanceof NeoRequestParam){
                            String paramName = ((NeoRequestParam) a).value();
    ...
    private void doInitHandlerMapping() {
        ...
        for (Map.Entry<String,Object> entry : ioc.entrySet()) {
            ...
            if(!clazz.isAnnotationPresent(NeoController.class)){ continue; }
        ...
        try {
            for (String className : classNames) {
                ...
                if(clazz.isAnnotationPresent(NeoController.class)) {
                    ...
                    //自定义命名
                    String beanName = clazz.getAnnotation(NeoService.class).value();
